...
class LocalPlanner(object):
    ...
    def run_step(self, debug=False):
        ...
        with open(f'{dir_outptut}/Locations.txt', 'a') as file:
        ...
        if len(self._waypoints_queue) == 0:
            ...
            # with open(f'{dir_outptut}/Controls_Town04_0_335.txt', 'a') as file:
            with open(f'{dir_outptut}/Controls.txt', 'a') as file:
                # file.write('{} {} {} {} {} {} {}\n'.format(
                #     control.throttle,
                #     control.steer,
                #     control.brake,

    ...
    try:
        if bLocalCarla:
            if not bGAIVI:
                ...
                carla = subprocess.Popen(f'srun --partition Contributors -w GPU6 --gpus=1 --pty singularity exec --nv /home/n/nsambhu/github/podman-carla/carla-0.9.14.sif /home/carla/CarlaUE4.sh -RenderOffScreen', shell=True)
                # time.sleep(30)                

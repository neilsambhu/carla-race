    ...
    try:
        if bLocalCarla:
            if not bGAIVI:
                ...
                # carla = subprocess.Popen('srun singularity exec --nv /home/n/nsambhu/github/podman-carla/carla-0.9.14.sif /home/carla/CarlaUE4.sh -RenderOffScreen &', shell=True, preexec_fn=os.setsid)
